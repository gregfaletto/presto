...
#   plot_1 <- cowplot::plot_grid(boxplot_2, boxplot_1, ratio_plot_2, ratio_plot_1,
#                       ncol = 2, nrow = 2)
...
#                       ncol = 2, nrow = 2)
#     } else if(n_plots == 1){
#       plot_1 <- cowplot::plot_grid(boxplot_1,ratio_plot_1,
#                       ncol = 2, nrow = 1)
#     }
...
#   plot_1 <- cowplot::plot_grid(boxplot_2, ratio_plot_2, ratio_plot_3, ratio_plot_1,
#                       ncol = 2, nrow = 2)
